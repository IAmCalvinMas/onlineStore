  ...
  <article>
    <nav>
      <ul class='nav nav-tabs' id='myTab' role='tablist'>
        <li class='nav-item'>
          <a class='nav-link text-dark active' id='placedOrdersTab' href='#placedOrders'
            data-toggle='tab' role='tab' aria-controls='placedOrders' aria-selected='false'>
            <ion-icon name="heart" class="align-middle"></ion-icon>
            <small id='smallOne'>OUR PRIVACY POLICY</small>
          </a>
        </li>
      </ul>
    </nav><br><br>
    <section class='tab-content' id='myTabContent'>
      <section class='tab-pane show active fade' id='placedOrders'
        role='tabpanel' aria-labelledby='placedOrdersTab'>
        <section>
          <p>
            Spacemilk (“we,” “our,” or “us”) is committed to protecting your privacy.
            This Privacy Policy explains how your personal information is collected,
            used, and disclosed by Spacemilk.
          </p>
          <p>
            ...
            Spacemilk. By accessing or using our Service, you signify that you
        ...
        <section>
          ...
          <ul>
            <li><b>Cookie:</b> small amount of data generated by a website and saved by your
            web browser. It is used to identify your browser, provide analytics,
            remember information about you such as your language preference or login information.</li>
            <li><b>Company:</b> when this policy mentions “Company,” “we,” “us,” or “our,”
            it refers to Spacemilk, 8178/27 zone f seshego 0742 that is responsible
            for your information under this Privacy Policy.</li>
            <li><b>Country:</b> where Spacemilk or the owners/founders of Spacemilk are based,
            in this case is South africa</li>
            <li><b>Customer:</b> refers to the company, organization or person that signs up
            to use the Spacemilk Service to manage the relationships with your
            consumers or service users.</li>
            <li><b>Device:</b> any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Spacemilk
            and use the services.</li>
            <li><b>IP address:</b> Every device connected to the Internet is assigned a
            number known as an Internet protocol (IP) address. These numbers
            are usually assigned in geographic blocks. An IP address can often be
            used to identify the location from which a device is connecting to the Internet.</li>
            <li><b>Personnel:</b> refers to those individuals who are employed by Spacemilk
            or are under contract to perform a service on behalf of one of the parties.</li>
            <li><b>Personal Data:</b> any information that directly, indirectly, or in
            connection with other information — including a personal identification
            number — allows for the identification or identifiability of a natural person.</li>
            <li><b>Service:</b> refers to the service provided by Spacemilk as described in
            the relative terms (if available) and on this platform.</li>
            <li><b>Third-party service:</b> refers to advertisers, contest sponsors,
            ...
            <li><b>Website:</b> Spacemilk’s site, which can be accessed via this URL:
            spacemilk.co.za</li>
            <li><b>You:</b> a person or entity that is registered with Spacemilk to use the
            Services.</li>
          </ul>
        </section><br>
        <section>
          ...
          <p>We also collect information from mobile devices for a better user
          experience, although these features are completely optional:</p>

          <p><b>Location (GPS):</b> Location data helps to create an accurate representation
          of your interests, and this can be used to bring more targeted and
          relevant ads to potential customers.</p>
        </section><br>
        <section>
          <h5>When does Spacemilk use end user information from third parties?</h5>
          <p>Spacemilk will collect End User Data necessary to provide the
            Spacemilk services to our customers. End users may voluntarily
            provide us with information they have made available on social
            media websites. If you provide us with any such information, we may
            collect publicly available information from the social media websites
             you have indicated. You can control how much of your information
             social media websites make public by visiting these websites and
             changing your privacy settings.</p>
        </section><br>
        <section>
          <h5>When does Spacemilk use customer information from third parties?</h5>
          <p>We receive some information from the third parties when you contact
             us. For example, when you submit your email address to us to show
             interest in becoming a Spacemilk customer, we receive information
             from a third party that provides automated fraud detection services
             to Spacemilk. We also occasionally collect information that is made
        ...
        <section>
          ...
          <p>We may share the information that we collect, both personal and
            ...
            to our successors-in-interest.</p>

          <p>We may engage trusted third party service providers to perform
            functions and provide services to us, such as hosting and maintaining
            our servers and the website, database storage and management,
            e-mail management, storage marketing, credit card processing,
            customer service and fulfilling orders for products and services
            you may purchase through the website. We will likely share your
            personal information, and possibly some non-personal information,
            with these third parties to enable them to perform these services
            for us and for you.</p>

          <p>We may share portions of our log file data, including IP addresses,
            ...
            shared location, and type of the device used to visit the website.
            They may aggregate information about our advertising and what you
            see on the website and then provide auditing, research and reporting
            for us and our advertisers.</p>

          <p>We may also disclose personal and non-personal information about
            ...
            unethical, or legally actionable activity, or to otherwise comply
        ...
        <section>
          ...
          <p>Spacemilk will collect personal information that you submit to us.
            We may also receive personal information about you from third
            parties as described above.</p>
        ...
        <section>
          ...
          <p>By submitting your email address on this website, you agree to
          ...
          or other unsubscribe option that is included in the respective email.
           We only send emails to people who have authorized us to contact them,
            either directly, or through a third party. We do not send unsolicited
             ...
             and updates pertaining to your order. If, however, you have provided
             the same email to us through another method, we may use it for any
             of the purposes stated in this Policy. Note: If at any time you would
        ...
        <section>
            ...
            <p>We keep your information only so long as we need it to provide Spacemilk
            to you and fulfill the purposes described in this policy.
        ...
        <section>
          ...
          <p>We implement a variety of security measures to maintain the safety
              ...
              secure server. All supplied sensitive/credit information is transmitted
              via Secure Socket Layer (SSL) technology and then encrypted into our
               ...
               Spacemilk or guarantee that your information on the Service may not
               be accessed, disclosed, altered, or destroyed by a breach of any of
               our physical, technical, or managerial safeguards.</p>
        </section><br>
        <section>
          <h5>Could my information be transferred to other countries?</h5>
          <p>Spacemilk is incorporated in South africa. Information collected
              ...
              to the trans-border transfer and hosting of such information.</p>

            </section><br>
        <section>
          <h5>Is the information collected through the Spacemilk Service secure?</h5>
          <p>We take precautions to protect the security of your information.
              We have physical, electronic, and managerial procedures to help
              safegui9ard, prevent unauthorized access, maintain data security,
              ...
              misconduct will be the standards used to measure our compliance
              with that duty.</p>
            </section><br>
        <section>
          <h5>Can I update or correct my information?</h5>
          <p>The rights you have to request updates or corrections to the
              information Spacemilk collects depend on your relationship with
              Spacemilk. Personnel may update or correct their information as
              detailed in our internal company employment policies.</p>
        </section><br>
        <section>
          <p>Customers have the right to request the restriction of certain
          ...
          <p>You should be aware that it is not technologically possible to
              ...
              or impossible for us to locate. Promptly after receiving your request,
              all personal information stored in databases we actively use,
              and other readily searchable media will be updated, corrected,
              changed or deleted, as appropriate, as soon as and to the extent
              reasonably and technically practicable.</p>
          <p>
        ...
        <section>
            <h5>Personnel</h5>
            <p>If you are a Spacemilk worker or applicant, we collect information
              ...
              and screen applicants.</p>
            <p>You may contact us in order to (1) update or correct your information,
              (2) change your preferences with respect to communications and
              other information you receive from us, or (3) receive a record of
              the information we have relating to you. Such updates, corrections,
              changes and deletions will have no effect on other information that
              we maintain, or information that we have provided to third parties
              in accordance with this Privacy Policy prior to such update,
              correction, change or deletion.</p>
        </section><br>
        <section>
          <h5>Sale of Business</h5>
          <p>We reserve the right to transfer information to a third party in
               the event of a sale, merger or other transfer of all or substantially
               all of the assets of Spacemilk or any of its Corporate Affiliates
               (as defined herein), or that portion of Spacemilk or any of its
        ...
        <section>
          <h5>Affiliates</h5>
          <p>We may disclose information (including personal information) about
              ...
              "Corporate Affiliate" means any person or entity which directly or
               ...
               with Spacemilk, whether by ownership or otherwise. Any information
        ...
        <section>
          <h5>Governing Law</h5>
          <p>This Privacy Policy is governed by the laws of South africa without
              ...
              Policy except for those individuals who may have rights to make
              claims under Privacy Shield, or the Swiss-US framework.</p>
          <p>The laws of South africa, excluding its conflicts of law rules,
          ...
          <p>By using Spacemilk or contacting us directly, you signify your
            ...
            information will mean that you accept those changes.</p>
        </section><br>
        <section>
          <h5>Your Consent</h5>
          <p>We've updated our Privacy Policy to provide you with complete
              transparency into what is being set when you visit our site and
              how it's being used. By using our Spacemilk, registering an account,
              or making a purchase, you hereby consent to our Privacy Policy
              and agree to its terms.</p>
        </section><br>
        <section>
          <h5>Links to Other Websites</h5>
          <p>This Privacy Policy applies only to the Services. The Services may
              contain links to other websites not operated or controlled by
              Spacemilk. We are not responsible for the content, accuracy or
        ...
        <section>
          <h5>Advertising</h5>
          <p>This website may contain third party advertisements and links to
            third party sites. Spacemilk does not make any representation as to
            ...
            sites and the offerings made by the third parties.</p>

            <p>Advertising keeps Spacemilk and many of the websites and services you
            use free of charge. We work hard to make sure that ads are safe,
            unobtrusive, and as relevant as possible.</p>

            <p>Third party advertisements and links to other sites where goods or
            services are advertised are not endorsements or recommendations by
            Spacemilk of the third party sites, goods or services. Spacemilk
        ...
        <section>
          ...
          <p>These cookies collect information over time about your online
              activity on the website and other online services to make
              online advertisements more relevant and effective to you.
              his is known as interest-based advertising. They also perform
              functions like preventing the same ad from continuously reappearing
              and ensuring that ads are properly displayed for advertisers.
        ...
        <section>
          ...
          <h5>Cookies</h5>
          <p>Spacemilk uses "Cookies" to identify the areas of our website
              ...
              or you would be required to enter your login details every time you
               visit the website as we would not be able to remember that you had
        ...
        <section>
          ...
          <p>Wherever you're located you may also set your browser to block
              ...
              different controls available to you. Disabling a cookie or category
              of cookie does not delete the cookie from your browser, you will
              need to do this yourself from within your browser, you should visit
              your browser's help menu for more information.</p>
        </section><br>
        <section>

          <h5>Payment Details</h5>
          <p>In respect to any credit card or other payment processing details
              you have provided us, we commit that this confidential information
              will be stored in the most secure manner possible.</p>
        </section><br>
        <section>
          <h5>Kids' Privacy</h5>
          <p>We do not address anyone under the age of 13. We do not knowingly
        ...
        <section>
          ...
          <p>We may change our Service and policies, and we may need to make
            ...
            this or any updated Privacy Policy, you can delete your account.</p>

        </section><br>
        <section>
          <h5>Third-Party Services</h5>
          <p>We may display, include or make available third-party content
            (including data, information, applications and other products services)
            or provide links to third-party websites or services ("Third- Party Services").</p>

          <p>You acknowledge and agree that Spacemilk shall not be responsible
            ...
            or any other aspect thereof. Spacemilk does not assume and shall not
            have any liability or responsibility to you or any other person or
            entity for any Third-Party Services.</p>

          <p>Third-Party Services and links thereto are provided solely as a
            convenience to you and you access and use them entirely at your own
            risk and subject to such third parties' terms and conditions.</p>
        </section><br>
        <section>
          <hgroup>
            <h4>Tracking Technologies</h4><br>
        ...
        <section>
          ...
          <p>
            ...
            be required to enter your login details every time you visit the as
        ...
        <section>
          <h5>Sessions</h5>
          <p>uses "Sessions" to identify the areas of our website that you have
        ...
        <section>
          ...
          <ul class='list-unstyled'>
            <li>
              ...
              <?php echo safe_mailto('info@Spacemilk.co.za', 'info@spacemilk.co.za'); ?>
            </li>
            <li>
              <ion-icon name="call" class="align-middle"></ion-icon>
              <span>065 871 2480</span>
            </li>
            <li>
              <ion-icon name="globe" class="align-middle"></ion-icon>
              <span>https://spacemilk.co.za</span>
            </li>
          </ul>
        </section>
      </section>
